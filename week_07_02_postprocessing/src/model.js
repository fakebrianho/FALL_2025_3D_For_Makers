...
export default class Model {
	...
	constructor(obj) {
		...
		//ABOVE WE HOOK INTO DRACO SO COMPRESSED MODELS CAN BE DECODED BEFORE THEY HIT THE SCENE
		...
		//DEFAULT TRANSFORMS HELP US PLACE EVERY INSTANCE IN THE WORLD EVEN IF THE CALLER DOESN'T PASS ANYTHING
	...
	initPoints() {
		//ALTERNATE INITIALIZER THAT CONVERTS MESH SURFACES INTO POINT CLOUDS FOR A DIFFERENT LOOK
		this.loader.load(this.file, (gltf) => {
			const meshes = []
	...
	createPoints(_mesh) {
		...
		//ADD ALPHA+ADDITIVE BLENDING SO THE POINTS FEEL LIKE SOFT GLOWING PARTICLES INSTEAD OF HARD PIXELS
