...
function init() {
	...
	meshes.default = addDefaultMeshes({ xPos: -2, yPos: 1 })
	meshes.floor = addFloor()
	meshes.standard = addStandardMesh({ xPos: 2, yPos: 1 })
...
function onPointerDown(event) {
	...
	if (intersects.length > 0) {
		if (intersects[0].object.userData.groupName == 'floor') return
