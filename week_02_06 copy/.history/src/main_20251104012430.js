...
function init() {
	...
	meshes.default = addDefaultMeshes({ color: 0x00ff00 })
	meshes.sphere = addSphereMeshes({ xPos: 2, color: 0xff0000 })
	meshes.torus = addTorusMeshes({ xPos: -2, color: 0xff00ff })
...
function animate() {
	...
	meshes.torus.rotation.y += 0.01
	meshes.torus.position.y = Math.sin(clock.getElapsedTime()) * 1.5

	meshes.default.rotation.y += 0.01
	meshes.default.position.y = Math.sin(clock.getElapsedTime()) * -1.5
