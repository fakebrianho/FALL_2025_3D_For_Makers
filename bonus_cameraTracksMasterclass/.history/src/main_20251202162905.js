...
const trainGeo = new THREE.SphereGeometry(0.3, 16, 16)
const trainMat = new THREE.MeshBasicMaterial({ color: 0x00ff00 })
...
function animate() {
	...
	debugT += clock.getDelta() * 0.1 // speed factor
	if (debugT > 1) debugT = 0

	// console.log(meshes.track)
	// const pos = meshes.track.curve.getPoint(debugT)
