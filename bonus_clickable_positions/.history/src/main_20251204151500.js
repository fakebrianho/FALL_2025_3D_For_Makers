...
const buttonData = [{position: new THREE.Vector3(-2, 0 , 3), active: false}, {position: new THREE.Vector3(0,0,3), active: false}, {position: new THREE.Vector3(2, 0 ,3), active: false}]
