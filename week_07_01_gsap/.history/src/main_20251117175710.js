...
function updateActiveState() {
	...
	// If at first position (index 0), left button is active
	// If at last position (index length-1), right button is active
	// Or you can make both active, or neither - adjust as needed
	if (currentIndex === 0) {
