...
camera.position.set(30, 0.5, 4)
// Look at car3 position (30, -0.3, 0)
camera.lookAt(30, -0.3, 0)
...
const carPositions = [30, 15, 0, -30, -15]
// Car Y positions and Z positions for lookAt
const carYPositions = [-0.3, -0.35, -0.35, -0.4, 0.065]
const carZPositions = [0, 0, 0, -0.45, -0.2]
...
function setupButtons() {
	...
	leftButton.addEventListener('click', () => {
		...
		const targetX = carPositions[currentIndex]
		const targetY = carYPositions[currentIndex]
		const targetZ = carZPositions[currentIndex]
...
function instances() {
	...
	const car4 = new Model({
		...
		position: new THREE.Vector3(-15, 0.065, -0.2),
	...
	const car5 = new Model({
		...
		position: new THREE.Vector3(-30, -0.4, -0.45),
	})
	car5.init()
}
